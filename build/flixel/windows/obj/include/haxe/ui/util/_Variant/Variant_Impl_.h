...
class HXCPP_CLASS_ATTRIBUTES Variant_Impl__obj : public ::hx::Object
{
	...
	public:
		...
		static  ::haxe::ui::util::VariantType fromImageData( ::flixel::graphics::frames::FlxFrame s);
		static ::Dynamic fromImageData_dyn();

		static  ::flixel::graphics::frames::FlxFrame toImageData( ::haxe::ui::util::VariantType this1);
