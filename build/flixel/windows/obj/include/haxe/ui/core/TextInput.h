...
class HXCPP_CLASS_ATTRIBUTES TextInput_obj : public  ::haxe::ui::backend::flixel::textinputs::OpenFLTextInput_obj
{
	public:
		typedef  ::haxe::ui::backend::flixel::textinputs::OpenFLTextInput_obj super;
