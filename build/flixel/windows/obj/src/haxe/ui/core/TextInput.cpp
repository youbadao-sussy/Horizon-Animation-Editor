...
void TextInput_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(_depth,"_depth");
	 ::haxe::ui::backend::flixel::textinputs::OpenFLTextInput_obj::__Mark(HX_MARK_ARG);
	HX_MARK_END_CLASS();
}
...
void TextInput_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(_depth,"_depth");
	 ::haxe::ui::backend::flixel::textinputs::OpenFLTextInput_obj::__Visit(HX_VISIT_ARG);
}
