...
HXDLIN(  40)				return ::Std_obj::string(s7);
            			...
            			break;
            			case (int)8: {
HXLINE(  41)				 ::flixel::graphics::frames::FlxFrame s8 = this1->_hx_getObject(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Variant_Impl__obj,get_isComponent,return )
 ...
 ::haxe::ui::util::VariantType Variant_Impl__obj::fromImageData( ::flixel::graphics::frames::FlxFrame s){
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Variant_Impl__obj,fromImageData,return )
 ...
 ::flixel::graphics::frames::FlxFrame Variant_Impl__obj::toImageData( ::haxe::ui::util::VariantType this1){
...
HXLINE( 230)			 ::flixel::graphics::frames::FlxFrame s = this1->_hx_getObject(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 230)			return s;
            		}
            		else {
...
HXLINE( 238)			 ::flixel::graphics::frames::FlxFrame _g = this1->_hx_getObject(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXLINE( 481)				unstringable2 = ::Std_obj::isOfType(r,::hx::ClassOf< ::flixel::graphics::frames::FlxFrame >());
            			}
            			else {
...
HXLINE( 514)								if (::Std_obj::isOfType(r,::hx::ClassOf< ::flixel::graphics::frames::FlxFrame >())) {
HXLINE( 515)									v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromImageData(::hx::TCast<  ::flixel::graphics::frames::FlxFrame >::cast(r));
            								}
            								else {
HXLINE( 520)									v = r;
            								}
...
HXLINE( 529)			_hx_tmp2 = ::Std_obj::isOfType(s,::hx::ClassOf< ::flixel::graphics::frames::FlxFrame >());
            		}
            		else {
...
HXDLIN( 557)					d = y7;
            				...
            				break;
            				case (int)8: {
HXLINE( 558)					 ::flixel::graphics::frames::FlxFrame y8 = v->_hx_getObject(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 558)					d = y8;
            				}
            				break;
            			}
