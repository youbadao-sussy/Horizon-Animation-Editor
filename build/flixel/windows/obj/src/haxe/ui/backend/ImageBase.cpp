...
void ImageBase_obj::__construct( ::Dynamic X, ::Dynamic Y, ::Dynamic SimpleGraphic){
...
::hx::ObjectPtr< ImageBase_obj > ImageBase_obj::__new( ::Dynamic X, ::Dynamic Y, ::Dynamic SimpleGraphic) {
	::hx::ObjectPtr< ImageBase_obj > __this = new ImageBase_obj();
	__this->__construct(X,Y,SimpleGraphic);
	return __this;
}

::hx::ObjectPtr< ImageBase_obj > ImageBase_obj::__alloc(::hx::Ctx *_hx_ctx, ::Dynamic X, ::Dynamic Y, ::Dynamic SimpleGraphic) {
