...
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_494_new,"openfl.utils._Dictionary.UtilsObjectMap","new",0xb7b17cf2,"openfl.utils._Dictionary.UtilsObjectMap.new","openfl/utils/Dictionary.hx",494,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_500_clear,"openfl.utils._Dictionary.UtilsObjectMap","clear",0xd3eae69f,"openfl.utils._Dictionary.UtilsObjectMap.clear","openfl/utils/Dictionary.hx",500,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_506_copy,"openfl.utils._Dictionary.UtilsObjectMap","copy",0xfc5e0ee3,"openfl.utils._Dictionary.UtilsObjectMap.copy","openfl/utils/Dictionary.hx",506,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_516_exists,"openfl.utils._Dictionary.UtilsObjectMap","exists",0x51d7188a,"openfl.utils._Dictionary.UtilsObjectMap.exists","openfl/utils/Dictionary.hx",516,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_527_get,"openfl.utils._Dictionary.UtilsObjectMap","get",0xb7ac2d28,"openfl.utils._Dictionary.UtilsObjectMap.get","openfl/utils/Dictionary.hx",527,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_533_keyValueIterator,"openfl.utils._Dictionary.UtilsObjectMap","keyValueIterator",0xf84f2d8e,"openfl.utils._Dictionary.UtilsObjectMap.keyValueIterator","openfl/utils/Dictionary.hx",533,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_539_keys,"openfl.utils._Dictionary.UtilsObjectMap","keys",0x01a03522,"openfl.utils._Dictionary.UtilsObjectMap.keys","openfl/utils/Dictionary.hx",539,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_544_iterator,"openfl.utils._Dictionary.UtilsObjectMap","iterator",0xcd47cc1c,"openfl.utils._Dictionary.UtilsObjectMap.iterator","openfl/utils/Dictionary.hx",544,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_549_remove,"openfl.utils._Dictionary.UtilsObjectMap","remove",0x967f96f2,"openfl.utils._Dictionary.UtilsObjectMap.remove","openfl/utils/Dictionary.hx",549,0x5979b1eb)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_559_toString,"openfl.utils._Dictionary.UtilsObjectMap","toString",0x721c52da,"openfl.utils._Dictionary.UtilsObjectMap.toString","openfl/utils/Dictionary.hx",559,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_488_boot,"openfl.utils._Dictionary.UtilsObjectMap","boot",0xfbb4d760,"openfl.utils._Dictionary.UtilsObjectMap.boot","openfl/utils/Dictionary.hx",488,0x5979b1eb)
namespace openfl{
namespace utils{
namespace _Dictionary{

void UtilsObjectMap_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_494_new)
HXDLIN( 494)		this->map =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
            	}
...
void UtilsObjectMap_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_500_clear)
HXDLIN( 500)		this->map->clear();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,clear,(void))
 ...
 ::openfl::utils::_Dictionary::UtilsObjectMap UtilsObjectMap_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_506_copy)
HXLINE( 507)		 ::openfl::utils::_Dictionary::UtilsObjectMap copied =  ::openfl::utils::_Dictionary::UtilsObjectMap_obj::__alloc( HX_CTX );
HXLINE( 508)		{
HXLINE( 508)			 ::Dynamic key = this->keys();
HXDLIN( 508)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 508)				 ::Dynamic key1 = key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXLINE( 509)				copied->set(key1,this->get(key1));
            			}
            		}
HXLINE( 510)		return copied;
            	}
...
bool UtilsObjectMap_obj::exists( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_516_exists)
HXDLIN( 516)		return this->map->exists(key);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(UtilsObjectMap_obj,exists,return )
 ...
 ::Dynamic UtilsObjectMap_obj::get( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_527_get)
HXDLIN( 527)		return this->map->get(key);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(UtilsObjectMap_obj,get,return )
 ...
 ::Dynamic UtilsObjectMap_obj::keyValueIterator(){
            	HX_GC_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_533_keyValueIterator)
HXDLIN( 533)		return  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,keyValueIterator,return )
 ...
 ::Dynamic UtilsObjectMap_obj::keys(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_539_keys)
HXDLIN( 539)		return this->map->keys();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,keys,return )
 ...
 ::Dynamic UtilsObjectMap_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_544_iterator)
HXDLIN( 544)		return this->map->iterator();
            	}
...
bool UtilsObjectMap_obj::remove( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_549_remove)
HXDLIN( 549)		return this->map->remove(key);
            	}
...
::String UtilsObjectMap_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_559_toString)
HXDLIN( 559)		return this->map->toString();
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_488_boot)
HXDLIN( 488)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
