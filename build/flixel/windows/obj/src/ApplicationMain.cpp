...
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Horizon Animation Editor",0e,81,17,11));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Horizon Animation Editor",0e,81,17,11))
